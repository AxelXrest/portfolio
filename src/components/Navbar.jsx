...
const Navbar = () => {
    ...
    return (
        <nav className={`
        ${styles.paddingX} w-full flex items-center py-4 fixed top-0 z-20 backdrop-blur-lg bg-[#07070799]`}>
            <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
                <Link
                    ...
                    <p className='text-white text-[16px] sm:text-[18px] font-semibold hidden xs:flex'>Ajaya Nemkul Shrestha</p>
                </Link>
                ...
                <div className='sm:hidden flex flex-1 justify-end items-center'>
                    ...
                    />
                    <div className={`${!toggle ? 'hidden' : 'flex'} backdrop-blur-[12px] p-6 bg-gradient-to-b from-[#000000d0] shadow-card to-[#00000051] border-[1px] border-gray-500 absolute top-20 left-2 right-2 my-2 z-10 rounded-xl`}>
